...
image_path = "nutrition_bg.jpg"  # Change this to your image file path
...
st.markdown(page_bg_img, unsafe_allow_html=True)  # Enable HTML within markdown for custom styles
...
show the protein,carbohydrates,fats in % and in grams in a table format with good color combination  
